...
indicators = {
    ...
    'P AT CIR LIQ': 'Preço da ação / Ativos Circulantes Líquidos por ação',
    ...
    'PEG Ratio': 'O PEG Ratio é uma métrica que verifica se o preço e lucro por ação é compatível com o crescimento da empresa. Quanto menor o PEG ratio, mais barata a ação em relação ao crescimento da empresa. Para o cálculo, assumimos o LPA Atual baseado nos últimos 4 trimestres, e o LPA Anterior os 4 trimestres anteriores a estes.(P/L) / [(LPA Atual / LPA Anterior) - 1]',
